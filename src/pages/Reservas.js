  ...
  return (
    <Fragment>
      ...
      <Grid container justifyContent="center" style={{backgroundColor:"#DDE4F1"}}>
        ...
        <Grid item xs={8} sm={8} md={7} marginTop="50px">          
          <Card variant="outlined" style={{ padding: "20px", boxShadow:"0px 4px 20px 1px rgba(0,0,0, 0.2)", borderRadius:"10px", backgroundColor:"#EEECE1", color:"#366092"}}>
            <div>
            <h3>{Bw[0].nombre}</h3>
            ...
            <Button variant="contained" color="success" onClick={reservar}>Reservar</Button>
            </Box>
            </div>
          </Card>
        </Grid>
